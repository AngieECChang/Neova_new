			...
			datetimepicker
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						mounth_picker.find('.xdsoft_label span').eq(1).text((options.format.charAt(0)==='R' ? _xdsoft_datetime.currentTime.getFullYear()-1911 : _xdsoft_datetime.currentTime.getFullYear()));
						...
						for (i = parseInt(options.yearStart, 10) + options.yearOffset; i <= parseInt(options.yearEnd, 10) + options.yearOffset; i += 1) {
							opt += '<div class="xdsoft_option ' + (_xdsoft_datetime.currentTime.getFullYear() === i ? 'xdsoft_current' : '') + '" data-value="' + i + '">' + (options.format.charAt(0)==='R' ? (i-1911) : i) + '</div>';
						}
 ...
 */
    ...
    Date.getFormatCode = function (a) {
        switch (a) {
            ...
            case"R":
                return "String.leftPad((this.getFullYear()-1911),3,'0') + ";
            default:
