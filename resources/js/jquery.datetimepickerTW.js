...
(function ($) {
    ...
    $.fn.datetimepickerTW = function (opt) {
        var KEY0 = 48,
            KEY9 = 57,
            _KEY0 = 96,
            _KEY9 = 105,
            ...
            datetimepicker
                .on('xchange.xdsoft', function (event) {
                    ...
                    xchangeTimer = setTimeout(function () {
                        ...
                        mounth_picker.find('.xdsoft_label span').eq(1).text(_xdsoft_datetime.currentTime.getFullYear()-1911);
    ...
    $.fn.datetimepickerTW.defaults = default_options;
}(jQuery));
(function () {
